...
public class ManageEmployeesViewController {
    ...
    Pattern userIdPattern=Pattern.compile("^(As-|Ph-)[0-9]{3}$");
    ...
    Pattern occupationPattern=Pattern.compile("^(Assistant|Pharmacist)$");
    ...
    private void setEmployeeId() {
        ...
        ValidationUtil.validate(txtEmpId,validationList);
        String username=new EmployeeManager().getUsername();
        txtUsername.setText(username);
        ValidationUtil.validate(txtUsername,validationList);
    }
