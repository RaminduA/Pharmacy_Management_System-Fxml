...
public class Medicine {
    ...
    public Medicine(String  code, String name, String description, String preservedTime, int qtyOnHand, double unitPrice, double unitSalePrice) {
        this.setCode(code);
        this.setName(name);
