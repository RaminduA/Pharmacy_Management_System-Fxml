...
CREATE TABLE IF NOT EXISTS `Order Detail`(
    orderId VARCHAR(8),
    medicineCode VARCHAR(8),
    unitPrice DECIMAL(8,2),
    quantity INT NOT NULL DEFAULT 0,
    price DECIMAL(8,2),
    CONSTRAINT PRIMARY KEY (medicineCode, orderid),
    CONSTRAINT FOREIGN KEY (medicineCode) REFERENCES Medicine(medicineCode) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS Medicine(
    ...
    CONSTRAINT PRIMARY KEY (medicineCode)
);
#===================================================================================================
...
CREATE TABLE IF NOT EXISTS `Stock Detail`(
    ...
    quantity INT NOT NULL DEFAULT 0,
    price DECIMAL(8,2),
    CONSTRAINT PRIMARY KEY (batchNo,medicineCode),
    CONSTRAINT FOREIGN KEY (medicineCode) REFERENCES Medicine(medicineCode) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `Price Detail`(
    ...
    CONSTRAINT PRIMARY KEY (medicineCode, name, date, time)
);
#===================================================================================================
